...
#added dictionary that maps each word to a set of indices of quotes where the word was found
...
if(isAnd):
        ...
        st=set([x for x in range(0,len(data_list))])
        for word in words:
                try:
...
if(failed!=True):
        ...
        s.sort()
        for item in s:
                print("Found at",item, data_list[item],"...\n")
